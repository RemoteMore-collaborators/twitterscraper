defmodule TwitterFeed.ParserTest do
  ...
  test "parsing of display_name" do
    html_snippet = "<div class=\"tweet\" data-name=\"CandyCrushSaga\"></div>"
